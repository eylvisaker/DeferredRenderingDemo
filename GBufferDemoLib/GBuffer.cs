...
namespace GBufferDemoLib
{
    public class GBuffer
    {
        ...
        private RenderTarget2D color, depth, normal, specular;
        ...
        internal void Rebuild()
        {
            ...
            specular = new RenderTarget2D(graphics, backBufferWidth, backBufferHeight, false, SurfaceFormat.Color, DepthFormat.Depth24Stencil8);
        }
