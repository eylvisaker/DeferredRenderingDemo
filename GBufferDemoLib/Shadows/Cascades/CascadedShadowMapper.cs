...
using GBufferDemoLib.Shadows.Cascades.Effects;
...
namespace GBufferDemoLib.Shadows
{
    ...
    public class CascadedShadowMapper
    {
        ...
        private List<RenderTarget2D> _shadowMaps = new List<RenderTarget2D>();
        ...
        public IReadOnlyList<RenderTarget2D> ShadowMaps => _shadowMaps;
        ...
        private void CreateShadowMaps()
        {
            ...
            {
                _shadowMaps.Add(new RenderTarget2D(_graphicsDevice,
                                                   ShadowMapSize,
                                                   ShadowMapSize,
                                                   false,
